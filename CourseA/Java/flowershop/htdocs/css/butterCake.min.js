!(function (a, t) {
  "use strict";
  var e, s, n;
  Window.prototype.ButterCake = Window.prototype.$BC =
    ((e = { plugins: {} }),
    (s = {}),
    (n = {
      breakPoints: { sm: 580, md: 780, lg: 1150, xl: 1250 },
      body: a("body , html"),
    }),
    {
      plugin: function (t, a, n) {
        (n = n),
          (e.plugins[t] = { enabled: n, run: a }),
          (s[t] = n),
          (this[t] = a),
          n && s[t] && e.plugins[t].run();
      },
      plugins: e.plugins,
      init: function () {
        var t = setTimeout(function () {
          a.each(s, function (t) {
            this && e.plugins[t].run();
          }),
            clearTimeout(t);
        }, 100);
      },
      initPlugin: function (t) {
        e.plugins[t] && e.plugins[t].run();
      },
      settings: n,
    });
})(jQuery, window),
      ...
      $(".navbar").each(function () {
        $(this).hasClass("expand-sm")
          ...
          $(this)
            ...
            .append('<div class="shadow-fixed"></div>');
      }),
        ...
        $(".navbar .shadow-fixed").click(function (t) {
          ...
          (("null" === t && "none" !== t) ||
            (t < a
              ...
              : ($(".menu-box").css("max-height", 0),
                ...
                n.each(function (t) {
                  var a = $(n)[t].scrollHeight;
                  $(this).attr("data-height", a);
                }))));
      });
    }
    var n = $(".navbar .menu-box"),
      a = $(".navbar .toggler");
    $(".navbar").each(function () {
      $(this).hasClass("expand-sm")
        ? $(this).attr("data-toggle", ButterCake.settings.breakPoints.sm)
      ...
      a.on("click", function () {
        var t = $(this).attr("data-nav");
        $(t).toggleClass("toggled");
        var a = parseFloat($(t).attr("data-height"));
        $(t).css("max-height", a + "px"),
          parseFloat($(t).css("max-height"))
            ? $(t).css("max-height", 0)
            : $(t).css("max-height", a + "px");
      });
  }),
    ...
    function () {
      ...
      $(".dropdown > a").on("click", function (t) {
        ...
        t.on("mouseleave", function (t) {
          t.stopPropagation(), $(this).removeClass("menu-showing");
        }),
        ButterCake.settings.body.on("click", function (t) {
          $(t.target).is(".dropdown") ||
  ...
  ButterCake.plugin(
    ...
    function () {
      function a(t) {
        var a = t.find(".modal-container").attr("data-modal-animate");
        return void 0 !== a && !1 !== a
          ? (a = a.split(","))
          : (t.find(".modal-container").addClass("animation-added"), ["", ""]);
      }
      function n(t) {
        t.removeClass("modal-exit").addClass("modal-show"),
          t.find(".modal-container").addClass("animated " + a(t)[0]),
          ButterCake.settings.body.addClass("noScroll"),
          setTimeout(function () {
            t.find(".modal-container").removeClass("animated " + a(t)[0]);
          }, 1e3);
      }
      function e(t) {
        t.find(".modal-container").addClass("animated " + a(t)[1]),
          "" === a(t)[1]
            ? (t.find(".modal-container").removeClass("animated " + a(t)[1]),
              t.removeClass("modal-show").addClass("modal-exit"),
              ButterCake.settings.body.removeClass("noScroll"))
            : setTimeout(function () {
                t.find(".modal-container").removeClass("animated " + a(t)[1]),
                  t.removeClass("modal-show").addClass("modal-exit"),
      ...
      $(".modal-open").on("click", function (t) {
        ...
        $(".modal").on("click", function (t) {
          $(t.target).is(".modal") && e($(".modal.modal-show"));
        });
    },
    !0
  ),
    ...
    function () {
      $(".tab-link").on("click", function () {
        var t = $(this).attr("data-tab"),
          a = $(this).closest(".tabs");
        a.find(".tab-nav .tab-link").removeClass("active"),
    ...
    function () {
      $(".accordion").each(function () {
        if ($(this).hasClass("active")) {
          var t = $(this).next(".panel");
          $(this)
            .next(".panel")
            .css("max-height", t[0].scrollHeight + "px");
        }
        $(".accordion").on("click", function () {
          $(".accordion").next(".panel").css("max-height", 0),
            ...
            parseFloat($(this).next(".panel").css("max-height"))
  ...
  ButterCake.plugin(
    ...
    function () {
      $(".alert .alert-close").on("click", function () {
        var t = $(this);
        t.parent(".dismissable").fadeOut("fast", function () {
          t.parent(".dismissable").remove();
        });
      });
    },
    !0
  ...
  ButterCake.plugin(
    ...
    function () {
      $(".chip .btn-clear-chip").on("click", function () {
        var t = $(this);
        t.closest(".chip").fadeOut("fast", function () {
  ...
  ButterCake.plugin("scrollSpy", function (t) {
    var n = {
      el: ".scrollSpy",
    ...
    $.extend(n, t),
      ...
      $(window).on("scroll", function () {
        $(n.spyEl).each(function () {
          if ($(window).scrollTop() >= $(this).offset().top - n.offset) {
            var t = $(this).attr("id");
            $(n.menuLi).removeClass(n.active),
              $(n.menu + " a[href=#" + t + "]")
                .parents("li")
                .addClass(n.active);
          }
